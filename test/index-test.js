...
describe( 'the local repository', () => {
  ...
  it( 'has been pushed up to the remote repository', () => {
    chai.assert.isDirectory( './my-repository/', 'no record of pushing to a remote was found. Follow the instructions on GitHub to connect and push to a new remote repository' );
  } )
